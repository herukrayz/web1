...
if(isset($_POST['simpan'])){
	...
	$jml = $_POST['jml'];
	include 'conn.php';
	mysqli_query($con,"INSERT INTO keluar VALUES (NULL, '".$_POST['tgl']."', '".$admin."',0)");
	$id = mysqli_insert_id($con);
	foreach($kd as $index => $value){
		mysqli_query($con,"INSERT INTO keluar_detail VALUES (NULL, '".$id."', '".$value."', '".$jml[$index]."')");
	}
...
?>
  <div class="content-wrapper">
    <div class="container-fluid">
      <ol class="breadcrumb">
        <li class="breadcrumb-item active">Output Barang</li>
      </ol>
      <div class="row">
