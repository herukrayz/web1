...
$id = $_GET['id'];
include 'conn.php';
$query1 = mysqli_query($con, "SELECT * FROM masuk where no='".$id."'");
$row1 = mysqli_fetch_array($query1, MYSQLI_NUM);
$query2 = mysqli_query($con, "SELECT masuk_detail.kd, barang.nm, masuk_detail.jml, barang.stn from masuk_detail inner join barang on masuk_detail.kd=barang.kd WHERE masuk_detail.no='".$id."'");
?>
<!DOCTYPE html>
<html lang="en">
<head>
